...
Quando a área do web design estava emergindo, não existiam softwares criados especificamente para visualizar layouts da web. Ao invés disso, designers cooptaram ferramentas existentes.
...
Se web designers desejassem estar do lado do espírito da One Web, eles precisavam oferecer a mesma essência do conteúdo na mesma URL para todos, independente de seu dispositivo. Ao mesmo tempo, eles precisavam estar aptos a criar layouts diferentes dependendo do verdadeiro estado da tela disponível.
...
Luke Wroblewski cunhou o termo "Mobile First" em reação a ascensão dos dispositivos móveis:
