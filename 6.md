...
Por último, podemos aplicar a mesma lógica que utilizamos para o site de notícias e estilizar nosso serviço. Utilizando CSS, podemos ter cor, textura, contraste, fontes web e para telas maiores, layout. Mas não vamos parar na apresentação. Vamos melhorar a interação também.
